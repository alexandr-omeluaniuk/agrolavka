...
public class FeedbackRestControllerTest extends AbstractAgrolavkaMvcTest {
    ...
    public void testGetListAndDelete() {
        ...
        withAuthorization(jwt(StandardRole.ROLE_SUBSCRIPTION_USER), () -> {
            ...
            final var entitiesList = callGet(SiteUrls.URL_PROTECTED + "/feedback", returnType, HttpStatus.OK);
            ...
            // delete
            callDelete(SiteUrls.URL_PROTECTED + "/feedback/" + feedback.getId(), Void.class, HttpStatus.OK);
