        ...
        <div class="agr-mobile-menu-slider">
            <div class="agr-mobile-menu-slide active agr-mobile-menu-main-slide">
                <div class="list-group list-group-flush py-2" style="overflow-y: auto;">
                    ...
                    <x-agr-menu-item class="p-1" link="/delivery#registration-info" label="Информация для покупателей" icon="info-circle" icon-color="light" label-color="dark"></x-agr-menu-item>
                    <x-agr-menu-item class="p-1" link="/delivery#delivery" label="Условия доставки" icon="truck" icon-color="light" label-color="dark"></x-agr-menu-item>
                    <x-agr-menu-item class="p-1" link="/delivery#discount-policy" label="Дисконтная программа" icon="percent" icon-color="light" label-color="dark"></x-agr-menu-item>
