                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8 gx-5 mb-4">
                            ...
                            <small class="text-muted">
                                Заявки по телефону обрабатываются пн-сб с 09:00 - 18:00.<br/>
                                Заявку через сайт Вы можете оформить круглосуточно. Обработка заявки происходит в указанное рабочее время.<br/>
                                Минимальная сумма заказа для доставки - <b>25 рублей</b><br/>
                                Отправка почтой, европочтой и другими курьерскими службами осуществляется с понедельника по пятницу. Стоимость пересылки согласно тарифам данных служб.<br/>
                                Пересылка средств защиты растений осуществляется курьерской службой, либо самовывозом.
                            </small>
                            ...
                            <small class="text-muted text-justify">
                                Вся информация, предоставляемая нам при оформлении заказа, остается конфиденциальной и не передается третьим лицам. Доставку продукции мы производим только по факту подтверждения заказа по телефону и согласования удобного дня и времени доставки.
                            ...
                            <ul class="list-unstyled">
                                ...
                                <li><small class="text-muted">Банковской картой через терминал (при самовывозе, доставке курьером по Беларуси).</small></li>
                                <li><small class="text-muted">Наложенным платежом (при доставке почтой, европочтой по Беларуси).</small></li>
                                <li><small class="text-muted">По безналичному расчету (для юридических лиц)</small></li>
                            </ul>
