...
public class PhoneApiService {
    ...
    @Value("${vats.secret.phoneapi:1111}")
    private String secretPhoneApi;

    public void createCall(CompletedCall call) {
        HttpHeaders headers = new HttpHeaders();
        headers.add("Lognex-Phone-Auth-Token", secretPhoneApi);
