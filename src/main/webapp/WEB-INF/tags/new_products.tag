...
<section class="text-center">
    ...
    <div id="agr-new-products-carousel" class="carousel slide carousel-fade" data-mdb-ride="carousel">
        ...
        <!-- Controls -->
        <button class="carousel-control-prev" type="button" data-mdb-target="#agr-new-products-carousel" data-mdb-slide="prev">
            <span class="carousel-control-prev-icon" aria-hidden="true"></span>
            <span class="visually-hidden">Previous</span>
        </button>
        <button class="carousel-control-next" type="button" data-mdb-target="#agr-new-products-carousel" data-mdb-slide="next">
